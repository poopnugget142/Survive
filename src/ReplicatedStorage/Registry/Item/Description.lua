...
return {
    ...
    [Item["Glock 17"]] =
    [[
    9mm Semi-Automatic Handgun from Austria, famous for its reliability. Less accurate than the Berreta, it makes up with compatibility with
    ...
    and out-of-the-box compatiable with suppressors, its no wonder why it's been often used by those who perfer to lurk in the shadows. 
    ]]

    --/Revolvers/--
    ;[Item["S&W Model 10"]] =
    [[
    .38 Caliber Double-Action Revolver from the United States, remains the most popular revolver in American history. Moderately powerful, 
    ...
    ;[Item["Colt Anaconda"]] =
    [[
    .44 Magnum Double-Action Revolver from the United States, the even bigger brother of the Colt "Snakegun" family. At one time, the .44 was
